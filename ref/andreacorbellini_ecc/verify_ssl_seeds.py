# ref: https://github.com/andreacorbellini/ecc/blob/master/scripts/verifyrandom.py
import collections
import hashlib

class VerificationFailed(Exception):
    pass # oh, this is a way to just declare a special type specific exception with a DerivedClass. Neat.

# namedtuple is new on me. https://www.geeksforgeeks.org/namedtuple-in-python/
# similar to dictionaries; but also supports access from key-value and iteration.
...
def verify_curve(curve):
    ...
    h = int.from_bytes(h, byteorder='big') # big endian
